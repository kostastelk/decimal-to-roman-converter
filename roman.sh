...
# Author Konstantinos Telkis E15184
# /////////////////////////////////////////////////////////////////////
...
# Συνάρτηση convertDecToRoman για μετατροπή του δεκαδικού σε ρωμαϊκό
convertDecToRoman(){
    #clear
...
# Συνάρτηση convertRomanToDec για μετατροπή του ρωμαϊκού σε δεκαδικό
convertRomanToDec(){
...
read -p "Δώσε έναν αριθμό σε δεκαδική ή σε ρωμαϊκή γραφή: " decvalue
if [ $decvalue -ge 0 ] || [ $decvalue -le 0 ]; then # Έλεγχος εάν είναι αριθμός
    if [ $decvalue -gt 0 ]; then  # Εάν είναι θετικός οκ κάλεσε την convertDecToRoman
        convertDecToRoman
    elif [ $decvalue -le 0 ]; then # Εάν είναι αρνητικός τότε μη συνεχίζεις
        echo "Αριθμός μικρότερος του 0"
    fi
